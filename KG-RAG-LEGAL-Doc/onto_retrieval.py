...
examples = [
#  "USER INPUT: 'Which regulations apply to IBM?' QUERY: MATCH (reg:Regulation)-[:appliesTo]->(entity:Financial_Entity {entityName: 'IBM'}) RETURN reg.regulationName,reg.chunk_index"
]
...
query_text = "List Article's present in title 1v"
